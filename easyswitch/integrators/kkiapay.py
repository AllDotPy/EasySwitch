"""
EasySwitch - KkiaPay Integrator (stub).
...
class KkiapayAdapter(BaseAdapter):
    """KkiaPay Adapter for EasySwitch SDK (placeholder)."""
    ...
    def format_transaction(self, data: TransactionDetail) -> Dict[str, Any]:
        raise UnsupportedOperationError("KkiaPay is not yet implemented")
