"""
EasySwitch - PayDunya Integrator (stub).
...
class PayDunyaAdapter(BaseAdapter):
    """PayDunya Adapter for EasySwitch SDK (placeholder)."""
    ...
    def format_transaction(self, data: TransactionDetail) -> Dict[str, Any]:
        raise UnsupportedOperationError("PayDunya is not yet implemented")
