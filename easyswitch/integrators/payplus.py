"""
EasySwitch - PayPlus Integrator (stub).
...
class PayPlusAdapter(BaseAdapter):
    """PayPlus Adapter for EasySwitch SDK (placeholder)."""
    ...
    def format_transaction(self, data: TransactionDetail) -> Dict[str, Any]:
        raise UnsupportedOperationError("PayPlus is not yet implemented")
